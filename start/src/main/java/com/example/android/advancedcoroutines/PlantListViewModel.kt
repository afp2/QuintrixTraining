...
class PlantListViewModel internal constructor(
    ...
    init {
        ...
        /* The original solution commented out to test the lambda challenge
         ...
         */
        //challenge attempt below
        //looks like it works
            val lambda : suspend (GrowZone) -> Unit = { growZone : GrowZone ->
                if (growZone == NoGrowZone) {
                    plantRepository.tryUpdateRecentPlantsCache()
                }
                else {
